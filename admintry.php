...
<body>
      ...
      <div class="tab-pane fade" id="skills" role="tabpanel" aria-labelledby="skills-tab">
        <form method="post" enctype="multipart/form-data">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="skillTitle" value="etitle" placeholder="Enter skill title">
          </div>
          <div class="mb-3">
            <label for="skillDescription" class="form-label">Skill Description</label>
            <textarea class="form-control" id="skillDescription" rows="5" value="edescription" placeholder="Enter skill description"></textarea>
          </div>
          <div class=mb-3>
            <label for="expFile" class="form-label"> Upload Files </label>
            <input type="file" class="form-control" id="expFile" name="eimage" multiple>
          </div>
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
    ...
    <h4 >click here to <a href="logout.php"> Logout  </h4>
</body>
...
//handle image update of exp and skill and store to database.
if(isset($_POST['esubmit'])){
   if(isset($_FILES['eimage'])){
       ...
       if($type== "image/jpeg" || $type == "image/png" || $type == "image/jpg"){
           if($size_converted<5){
               move_uploaded_file($fileTemp, 'images/' .$newfilename);
               $query = "INSERT INTO exp(eimage) VALUES('$newfilename')";
...
//handle exp and skill update
if(isset($_POST['esubmit'])){
  $etitle = $_POST['etitle'];
  $edescription = $_POST['edescription'];
  $query = "UPDATE experience SET title='$etitle' , descrption = '$edescription' where id = 1;";
